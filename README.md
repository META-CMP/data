...
Folders with replication files for the data analysis in our research papers are linked [above](https://github.com/META-CMP/data/blob/main/README.md#pre-registration).
