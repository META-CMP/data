...
# Save data
#write_csv(avg_irf_output_median$data, file.path(save_path, "avg_irf_output_median_amoderation.csv"))
...
# Export PDF
out_pdf <- file.path(save_path, "avg_irf_output_median_amoderation.pdf")
ggsave(
  filename = out_pdf,
  plot     = p_out,
  width    = 360/72,
...
# Save data
#write_csv(avg_irf_pricelevel_median$data, file.path(save_path, "avg_irf_pricelevel_median_amoderation.csv"))
...
# Export PDF
out_pdf <- file.path(save_path, "avg_irf_pricelevel_median_amoderation.pdf")
ggsave(
  filename = out_pdf,
  plot     = p_out,
  width    = 360/72,
...
# Save data
#write_csv(avg_irf_rate_median$data, file.path(save_path, "avg_irf_rate_median_amoderation.csv"))
...
# Export PDF
out_pdf <- file.path(save_path, "avg_irf_rate_median_amoderation.pdf")
ggsave(
  filename = out_pdf,
  plot     = p_out,
  width    = 360/72,
