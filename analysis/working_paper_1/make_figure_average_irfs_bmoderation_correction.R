...
fatpet_uw_output_bmoderation <- meta_analysis(d_no_qc,
                                             outvar = out_var,
                                             se_option = "upper",
...
fatpet_uw_output_bmoderation <- extract_intercepts(fatpet_uw_output_bmoderation)
...
# Save data
#write_csv(avg_irf_output_median$data, file.path(save_path, "avg_irf_output_median_ols_bmoderation.csv"))
...
p_out <- ggplot(df_plot, aes(x = period.month)) +
  ...
  geom_line(
    data = fatpet_uw_output_bmoderation,
...
# Export PDF
out_pdf <- file.path(save_path, "avg_irf_output_median_ols_bmoderation.pdf")
ggsave(
  filename = out_pdf,
  plot     = p_out,
  width    = 360/72,
...
### Estimate FAT-PET without weights ----
fatpet_uw_pricelevel_bmoderation <- meta_analysis(d_no_qc,
                                              outvar = out_var,
                                              se_option = "upper",
                                              periods = seq(0, 60, by = 3),
                                              wins = wins_para,
...
fatpet_uw_pricelevel_bmoderation <- extract_intercepts(fatpet_uw_pricelevel_bmoderation)
...
# Save data
#write_csv(avg_irf_pricelevel_median$data, file.path(save_path, "avg_irf_pricelevel_median_ols_bmoderation.csv"))
...
p_out <- ggplot(df_plot, aes(x = period.month)) +
  ...
  # FAT-PET UW intercepts (OLS correction)
  geom_line(
    data = fatpet_uw_pricelevel_bmoderation,
    aes(x = period, y = estimate, color = "OLS correction"),
    linetype = "11",
    linewidth = 1.4
  ) +
...
# Export PDF
out_pdf <- file.path(save_path, "avg_irf_pricelevel_median_ols_bmoderation.pdf")
ggsave(
  filename = out_pdf,
  plot     = p_out,
  width    = 360/72,
...
### Estimate FAT-PET without weights ----
fatpet_uw_rate_bmoderation <- meta_analysis(d_no_qc,
                                                  outvar = out_var,
                                                  se_option = "avg",
                                                  periods = seq(0, 60, by = 3),
                                                  wins = wins_para,
...
fatpet_uw_rate_bmoderation <- extract_intercepts(fatpet_uw_rate_bmoderation)
...
# Save data
#write_csv(avg_irf_rate_median$data, file.path(save_path, "avg_irf_rate_median_ols_bmoderation.csv"))
...
p_out <- ggplot(df_plot, aes(x = period.month)) +
  ...
  # FAT-PET UW intercepts (OLS correction)
  geom_line(
    data = fatpet_uw_rate_bmoderation,
    aes(x = period, y = estimate, color = "OLS correction"),
    linetype = "11",
    linewidth = 1.4
  ) +
...
# Export PDF
out_pdf <- file.path(save_path, "avg_irf_rate_median_ols_bmoderation.pdf")
ggsave(
  filename = out_pdf,
  plot     = p_out,
  width    = 360/72,
