...
# Robustness check excluding GFC period : Use only obs before GFC ----
d_no_qc <- d_no_qc %>%
  filter(
    end_date   <  "2007-09-01")
...
# Save data
#write_csv(avg_irf_output_median$data, file.path(save_path, "avg_irf_output_median_gfc.csv"))
...
# Export PDF
out_pdf <- file.path(save_path, "avg_irf_output_median_gfc.pdf")
ggsave(
  filename = out_pdf,
  plot     = p_out,
  width    = 360/72,
...
# Save data
#write_csv(avg_irf_pricelevel_median$data, file.path(save_path, "avg_irf_pricelevel_median_gfc.csv"))
...
# Export PDF
out_pdf <- file.path(save_path, "avg_irf_pricelevel_median_gfc.pdf")
ggsave(
  filename = out_pdf,
  plot     = p_out,
  width    = 360/72,
...
# Save data
#write_csv(avg_irf_rate_median$data, file.path(save_path, "avg_irf_rate_median_gfc.csv"))
...
# Export PDF
out_pdf <- file.path(save_path, "avg_irf_rate_median_gfc.pdf")
ggsave(
  filename = out_pdf,
  plot     = p_out,
  width    = 360/72,
