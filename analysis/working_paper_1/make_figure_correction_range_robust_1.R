...
# Robustness check 1: Use only GDP and CPI as outcome_measure ----
d_no_qc <- d_no_qc %>% 
  filter(outcome_measure %in% c("cpi", "gdp", "rate"))

# Sub-folder for figures ----
subfolder <- "robust_gdp_cpi" # robustness check 1
# This version:
# Methods:
## FAT-PET unweighted
## FAT-PET
## PEESE unweighted
## PEESE
## WAAP (2.8 for output and interest rate, 1.84 for price level, horizon-based model selection)
## WAAP (2.8 for output and interest rate, 1.84 for price level, horizon-based model selection) unweighted
## AK
...
write_csv(figure_irf_range_correction_output$data, here::here(paste0("analysis/working_paper_1/figures/irf_range_correction/", subfolder, "/figure_irf_range_correction_output_robust_1.csv")))
...
orca(figure_irf_range_correction_output,
     file = paste0("analysis/working_paper_1/figures/irf_range_correction/", subfolder, "/figure_irf_range_correction_output_robust_1.pdf"),
     scale = NULL,
     width = 360,
     height = 486 * 0.65
)
...
figure_irf_range_correction_pricelevel$data <- figure_irf_range_correction_pricelevel$data %>%
  ...
  left_join(mean_median_per_period, by = "period.month")
# Save figure data as csv
write_csv(figure_irf_range_correction_pricelevel$data, here::here(paste0("analysis/working_paper_1/figures/irf_range_correction/", subfolder, "/figure_irf_range_correction_pricelevel_robust_1.csv")))
...
orca(figure_irf_range_correction_pricelevel,
     file = paste0("analysis/working_paper_1/figures/irf_range_correction/", subfolder, "/figure_irf_range_correction_pricelevel_robust_1.pdf"),
     scale = NULL,
     width = 360,
     height = 486 * 0.65
)
...
figure_irf_range_correction_rate$data <- figure_irf_range_correction_rate$data %>%
  ...
  left_join(mean_median_per_period, by = "period.month")
# Save figure data as csv
write_csv(figure_irf_range_correction_rate$data, here::here(paste0("analysis/working_paper_1/figures/irf_range_correction/", subfolder, "/figure_irf_range_correction_rate_robust_1.csv")))
...
orca(figure_irf_range_correction_rate,
     file = paste0("analysis/working_paper_1/figures/irf_range_correction/", subfolder, "/figure_irf_range_correction_rate_robust_1.pdf"),
     scale = NULL,
     width = 360,
     height = 486 * 0.65
)
