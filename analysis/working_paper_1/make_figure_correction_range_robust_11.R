...
# Robustness check 11: Use only Industrial Production (output) ----
d_no_qc <- d_no_qc %>% 
  filter(!(outcome_measure_output_cons %in% c("gdp", "gap")))
...
subfolder <- "robust_ip" # Robustness check 11
# This version:
# Methods:
## FAT-PET unweighted
## FAT-PET
...
write_csv(figure_irf_range_correction_output$data, here::here(paste0("analysis/working_paper_1/figures/irf_range_correction/", subfolder, "/figure_irf_range_correction_output_robust_11.csv")))
...
out_pdf <- here::here(
  paste0("analysis/working_paper_1/figures/irf_range_correction/", subfolder,
         "/figure_irf_range_correction_output_robust_11.pdf")
)
...
figure_irf_range_correction_pricelevel$data <- figure_irf_range_correction_pricelevel$data %>%
  ...
  left_join(mean_median_per_period, by = "period.month")
# Save figure data as csv
write_csv(figure_irf_range_correction_pricelevel$data, here::here(paste0("analysis/working_paper_1/figures/irf_range_correction/", subfolder, "/figure_irf_range_correction_pricelevel_robust_11.csv")))
...
out_pdf <- here::here(
  paste0("analysis/working_paper_1/figures/irf_range_correction/", subfolder,
         "/figure_irf_range_correction_pricelevel_robust_11.pdf")
)
dir.create(dirname(out_pdf), recursive = TRUE, showWarnings = FALSE)
...
figure_irf_range_correction_rate$data <- figure_irf_range_correction_rate$data %>%
  ...
  left_join(mean_median_per_period, by = "period.month")
# Save figure data as csv
write_csv(figure_irf_range_correction_rate$data, here::here(paste0("analysis/working_paper_1/figures/irf_range_correction/", subfolder, "/figure_irf_range_correction_rate_robust_11.csv")))
...
out_pdf <- here::here(
  paste0("analysis/working_paper_1/figures/irf_range_correction/", subfolder,
         "/figure_irf_range_correction_rate_robust_11.pdf")
)
dir.create(dirname(out_pdf), recursive = TRUE, showWarnings = FALSE)
