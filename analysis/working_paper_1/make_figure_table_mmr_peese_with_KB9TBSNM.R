...
###### The only difference in this script compared to the file "make_figure_table_mmr_peese.R" is that the outlier is not dropped here. 
# Remove key KB9TBSNM from d_no_qc
...
robustness_mods_output <- c(est_mod, output_measure, int_rate_mod)
robusntess_coef_names_output <- c(est_coef_name, output_measure_coef_name, int_rate_coef_name)
robustness_mods_pricelevel <- c(est_mod, pricelevel_measure, int_rate_mod)
robusntess_coef_names_pricelevel <- c(est_coef_name, int_rate_coef_name, pricelevel_measure_coef_name)
...
##### Save table as png
modelsummary::modelsummary(mmr_output_baseline[as.character(chosen_periods_tables)],
                           output = paste0("analysis/working_paper_1/tables/mmr_peese/", "mmr_output_baseline_with_KB9TBSNM", ".png"),
                           stars = FALSE, 
                           fmt = 3,
                           conf_level = conflevel, 
                           gof_map = "nobs", 
...
# Save as pdf
ggsave(here::here("analysis/working_paper_1/figures/mmr/figure_mmr_output_baseline_intercept_p_bias_with_KB9TBSNM.pdf"),
...
# Save as pdf
ggsave(here::here("analysis/working_paper_1/figures/mmr/figure_mmr_output_baseline_moderators_with_KB9TBSNM.pdf"),
       plot = combined_plot,
       device = "pdf",
       width = 7,
       height = 9)
...
# Save as pdf
ggsave(here::here("analysis/working_paper_1/figures/mmr/figure_mmr_output_baseline_corrected_effects_ident_with_KB9TBSNM.pdf"),
...
##### Save table as png
modelsummary::modelsummary(mmr_output_robust[as.character(chosen_periods_tables)],
                           output = paste0("analysis/working_paper_1/tables/mmr_peese/", "mmr_output_robust_with_KB9TBSNM", ".png"),
                           stars = FALSE, 
                           fmt = 3,
                           conf_level = conflevel, 
                           gof_map = "nobs", 
...
# Save as pdf
ggsave(here::here("analysis/working_paper_1/figures/mmr/figure_mmr_output_robust_intercept_p_bias_with_KB9TBSNM.pdf"),
...
# Save as pdf
ggsave(here::here("analysis/working_paper_1/figures/mmr/figure_mmr_output_robust_moderators_with_KB9TBSNM.pdf"),
       plot = combined_plot,
       device = "pdf",
       width = 7,
       height = 9)
...
# Save as pdf
ggsave(here::here("analysis/working_paper_1/figures/mmr/figure_mmr_output_robust_moderators_est_with_KB9TBSNM.pdf"),
...
##### Save table as png
modelsummary::modelsummary(mmr_pricelevel_baseline[as.character(chosen_periods_tables)],
                           output = paste0("analysis/working_paper_1/tables/mmr_peese/", "mmr_pricelevel_baseline_with_KB9TBSNM", ".png"),
                           stars = FALSE, 
                           fmt = 3,
                           conf_level = conflevel, 
                           gof_map = "nobs", 
...
# Save as pdf
ggsave(here::here("analysis/working_paper_1/figures/mmr/figure_mmr_pricelevel_baseline_intercept_p_bias_with_KB9TBSNM.pdf"),
...
# Save as pdf
ggsave(here::here("analysis/working_paper_1/figures/mmr/figure_mmr_pricelevel_baseline_moderators_with_KB9TBSNM.pdf"),
       plot = combined_plot,
       device = "pdf",
       width = 7,
       height = 9)
...
(mmr_pricelevel_baseline_corrected_effects_ident <- ggplot(prediction, 
    ...
    geom_point(data = prediction %>% filter(source == "Uncorrected"), 
               ...
               size = 2))
# Save as pdf
ggsave(here::here("analysis/working_paper_1/figures/mmr/figure_mmr_pricelevel_baseline_corrected_effects_ident_with_KB9TBSNM.pdf"),
...
##### Save table as png
modelsummary::modelsummary(mmr_pricelevel_robust[as.character(chosen_periods_tables)],
                           output = paste0("analysis/working_paper_1/tables/mmr_peese/", "mmr_pricelevel_robust_with_KB9TBSNM", ".png"),
                           stars = FALSE, 
                           fmt = 3,
                           # statistic = NULL,
                           conf_level = conflevel, 
...
# Save as pdf
ggsave(here::here("analysis/working_paper_1/figures/mmr/figure_mmr_pricelevel_robust_intercept_p_bias_with_KB9TBSNM.pdf"),
...
# Save as pdf
ggsave(here::here("analysis/working_paper_1/figures/mmr/figure_mmr_pricelevel_robust_moderators_with_KB9TBSNM.pdf"),
       plot = combined_plot,
       device = "pdf",
       width = 7,
       height = 9)
...
# Save as pdf
ggsave(here::here("analysis/working_paper_1/figures/mmr/figure_mmr_pricelevel_robust_moderators_est_with_KB9TBSNM.pdf"),
       plot = combined_plot_est,
       device = "pdf",
       width = 7,
       height = 12)
