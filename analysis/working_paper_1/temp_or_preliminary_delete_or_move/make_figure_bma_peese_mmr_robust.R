# MMR robustness: Bayesian Model Averaging (BMA) and weighted peese MMR comparison

# Robustness check MMR version with SE2 with inverse-variance weights ----
source(here::here("analysis/working_paper_1/mmr_peese_robust_for_bma.R"))
...
bma_data <- d_no_qc %>% 
  ...
  mutate(         
    ...
    SE2 = SE^2,  # Calculate SE2 after we've grabbed SE for weights
    weight = 1/SE  # This is sqrt(1/SE²) which is the transformation factor for WLS
  ) %>%
  select(
    ...
    panel,
    weight # Weights for WLS transformation
  )
...
#### Plots ----
##### Coefficient plots ----
p1 <- create_mmr_coefficient_plot(mmr_output_robust, "(Intercept)", conf_levels = c(0.67, 0.89, 0.97),
...
p2 <- create_mmr_coefficient_plot(mmr_output_robust, "variance_winsor", conf_levels = c(0.67, 0.89, 0.97),
...
y_lims <- c(-1.5, 0.5)
p3 <- create_mmr_coefficient_plot(mmr_output_robust, "group_ident_broadhf", conf_levels = c(0.67, 0.89, 0.97), 
                                  custom_title = "HF") +
...
p4 <- create_mmr_coefficient_plot(mmr_output_robust, "group_ident_broadnr", conf_levels = c(0.67, 0.89, 0.97), 
                                  custom_title = "NR") +
  coord_cartesian(ylim = y_lims) +
  # No subtitle
  theme(plot.subtitle = element_blank()) +
...
p5 <- create_mmr_coefficient_plot(mmr_output_robust, "group_ident_broadsignr", conf_levels = c(0.67, 0.89, 0.97), 
                                  custom_title = "SignR") +
  coord_cartesian(ylim = y_lims) +
  # No subtitle
  theme(plot.subtitle = element_blank()) +
...
p6 <- create_mmr_coefficient_plot(mmr_output_robust, "group_ident_broadidother", conf_levels = c(0.67, 0.89, 0.97), 
                                  custom_title = "Other") +
  coord_cartesian(ylim = y_lims) +
  # No subtitle
  theme(plot.subtitle = element_blank()) +
...
p7 <- create_mmr_coefficient_plot(mmr_output_robust, "top_5_or_tier", conf_levels = c(0.67, 0.89, 0.97), 
...
p8 <- create_mmr_coefficient_plot(mmr_output_robust, "cbanker", conf_levels = c(0.67, 0.89, 0.97), 
...
p9 <- create_mmr_coefficient_plot(mmr_output_robust, "group_est_broadlp_ardl", conf_levels = c(0.67, 0.89, 0.97), 
...
p10 <- create_mmr_coefficient_plot(mmr_output_robust, "group_est_broadfavar", conf_levels = c(0.67, 0.89, 0.97), 
                                   custom_title = "FAVAR") +
  coord_cartesian(ylim = y_lims) +
  # No subtitle
  theme(plot.subtitle = element_blank()) +
...
p11 <- create_mmr_coefficient_plot(mmr_output_robust, "group_est_broadother_var", conf_levels = c(0.67, 0.89, 0.97), 
...
p12 <- create_mmr_coefficient_plot(mmr_output_robust, "group_est_broaddsge", conf_levels = c(0.67, 0.89, 0.97), 
                                   custom_title = "DSGE") +
  coord_cartesian(ylim = y_lims) +
  # No subtitle
  theme(plot.subtitle = element_blank()) +
...
p13 <- create_mmr_coefficient_plot(mmr_output_robust, "outcome_measure_output_consgap", conf_levels = c(0.67, 0.89, 0.97), 
...
p14 <- create_mmr_coefficient_plot(mmr_output_robust, "outcome_measure_output_consip", conf_levels = c(0.67, 0.89, 0.97), 
                                   custom_title = "IP") +
  coord_cartesian(ylim = y_lims) +
  # No subtitle
  theme(plot.subtitle = element_blank()) +
...
p15 <- create_mmr_coefficient_plot(mmr_output_robust, "group_inttypeweek_month", conf_levels = c(0.67, 0.89, 0.97), 
...
p16 <- create_mmr_coefficient_plot(mmr_output_robust, "group_inttypeyear", conf_levels = c(0.67, 0.89, 0.97), 
...
p17 <- create_mmr_coefficient_plot(mmr_output_robust, "pub_year_dm", conf_levels = c(0.67, 0.89, 0.97), 
...
p18 <- create_mmr_coefficient_plot(mmr_output_robust, "num_cit_dm", conf_levels = c(0.67, 0.89, 0.97), 
...
p19 <- create_mmr_coefficient_plot(mmr_output_robust, "prefer", conf_levels = c(0.67, 0.89, 0.97), 
...
p20 <- create_mmr_coefficient_plot(mmr_output_robust, "byproduct", conf_levels = c(0.67, 0.89, 0.97), 
...
p21 <- create_mmr_coefficient_plot(mmr_output_robust, "freqmonth", conf_levels = c(0.67, 0.89, 0.97), 
...
p22 <- create_mmr_coefficient_plot(mmr_output_robust, "freqannual", conf_levels = c(0.67, 0.89, 0.97), 
                                   custom_title = "Annual") +
  coord_cartesian(ylim = y_lims) +
  # No subtitle
  theme(plot.subtitle = element_blank()) +
...
p23 <- create_mmr_coefficient_plot(mmr_output_robust, "panel", conf_levels = c(0.67, 0.89, 0.97), 
                                   custom_title = "Panel") +
  coord_cartesian(ylim = y_lims) +
  # No subtitle
  theme(plot.subtitle = element_blank()) +
