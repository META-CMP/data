...
for (outcome in unique(d_no_qc$outcome)) {
  ...
  subset_data <- d_no_qc[
    d_no_qc$period.month == 1 & d_no_qc$outcome == outcome,
  ]
...
d_no_qc$top_5_or_tier <- factor(
  d_no_qc$top_5_or_tier,
  levels = c(0, 1),
  labels = c("other publication", "top journal")
)
d_no_qc$cbanker <- factor(
  d_no_qc$cbanker,
  levels = c(0, 1),
...
avg_irf_emp <- plot_average_irfs(
  d_no_qc %>%
    plotly::filter(period.month %in% seq(0, 60, by = 3), outcome == out_var),
  period_limit = 60,
  winsor = TRUE,
  wins_par = wins_para,
  corrected_irf = NULL,
...
# Save data as csv
write_csv(
  avg_irf_emp_median$data,
  here::here(save_path, "avg_irf_emp_median.csv")
)
# Change plot title
avg_irf_emp_median <- avg_irf_emp_median$plot %>%
  plotly::layout(
...
model_waap_uw_emp <- meta_analysis(
  d_no_qc,
  outvar = out_var,
  se_option = "upper",
  periods = seq(0, 60, by = 3),
...
# Save data as csv
write_csv(
  avg_irf_emp_median_se_bounds$data,
  here::here(save_path, "avg_irf_emp_median_se_bounds.csv")
)
# Change plot title
avg_irf_emp_median_se_bounds <- avg_irf_emp_median_se_bounds$plot %>%
  plotly::layout(
...
figure_avg_irf_emp_median_se_bounds <- subplot(
  avg_irf_emp_median,
  ...
  layout(
    ...
    yaxis = list(title = "Effect (%)", range = list(-2.8, 0.8)),
    yaxis2 = list(range = list(-2.8, 0.8)),
    hovermode = "compare"
  )
# Save as pdf
orca(
  figure_avg_irf_emp_median_se_bounds,
...
# Change plot title
avg_irf_unemp <- avg_irf_unemp$plot %>%
  plotly::layout(
...
# Save data as csv
write_csv(
  avg_irf_unemp_median$data,
  here::here(save_path, "avg_irf_unemp_median.csv")
)
# Change plot title
avg_irf_unemp_median <- avg_irf_unemp_median$plot %>%
  plotly::layout(
...
### Estimate WAAP with model selection based on horizon ----
model_waap_unemp <- meta_analysis(
  d_no_qc,
  outvar = out_var,
  se_option = "lower",
  periods = seq(0, 60, by = 3),
...
### Estimate AAP (unweigthed WAAP) with model selection based on horizon ----
model_waap_uw_unemp <- meta_analysis(
  d_no_qc,
  outvar = out_var,
  se_option = "lower",
  periods = seq(0, 60, by = 3),
...
# Save data as csv
write_csv(
  avg_irf_unemp_median_se_bounds$data,
  here::here(save_path, "avg_irf_unemp_median_se_bounds.csv")
)
# Change plot title
avg_irf_unemp_median_se_bounds <- avg_irf_unemp_median_se_bounds$plot %>%
  plotly::layout(
...
figure_avg_irf_unemp_median_se_bounds <- subplot(
...
# Save as pdf
orca(
  figure_avg_irf_unemp_median_se_bounds,
...
figure_average_irfs_emp_unemp <- subplot(
  avg_irf_emp,
  avg_irf_unemp,
  nrows = 1,
  margin = 0.03
...
figure_average_irfs_emp_unemp_with_median <- subplot(
  avg_irf_emp_median,
  avg_irf_unemp_median
) %>%
  layout(
...
figure_average_irfs_emp_unemp_corrections <- subplot(
  avg_irf_emp_corrections,
  avg_irf_unemp_corrections
) %>%
  layout(
...
# Change plot title
avg_irf_rate <- avg_irf_rate$plot %>%
  plotly::layout(
...
# Save data as csv
write_csv(
  avg_irf_rate_median$data,
  here::here(save_path, "avg_irf_rate_median.csv")
)
# Change plot title
avg_irf_rate_median <- avg_irf_rate_median$plot %>%
  plotly::layout(
...
### Estimate AAP (unweigthed WAAP) with model selection based on horizon ----
model_waap_uw_rate <- meta_analysis(
  d_no_qc,
  outvar = out_var,
  se_option = "avg",
  periods = seq(0, 60, by = 3),
...
# Save data as csv
write_csv(
  avg_irf_rate_median_se_bounds$data,
  here::here(save_path, "avg_irf_rate_median_se_bounds.csv")
)
# Change plot title
avg_irf_rate_median_se_bounds <- avg_irf_rate_median_se_bounds$plot %>%
  plotly::layout(
    title = "Average and median IRF for Interest Rate",
...
figure_avg_irf_rate_median_se_bounds <- subplot(
  avg_irf_rate_median,
  ...
  layout(
    xaxis = list(title = "Months"),
    xaxis2 = list(title = "Months"),
    yaxis = list(title = "Effect (%-points)", range = list(-1, 1.5)),
    yaxis2 = list(range = list(-1, 1.5)),
    hovermode = "compare"
  )
# Save as pdf
orca(
  figure_avg_irf_rate_median_se_bounds,
...
figure_average_irfs_emp_unemp_rate_with_median <- subplot(
  subplot(avg_irf_emp_median, avg_irf_unemp_median, shareY = TRUE),
  avg_irf_rate_median,
  widths = c(.66, .33)
) %>%
  layout(
...
figure_average_irfs_emp_unemp_rate_corrections <- subplot(
  subplot(avg_irf_emp_corrections, avg_irf_unemp_corrections, shareY = FALSE),
  avg_irf_rate_corrections,
  widths = c(.66, .33)
) %>%
  layout(
...
# Save data as csv
write_csv(
  avg_irf_emp_top_journals$data,
  here::here(save_path, "avg_irf_emp_top_journals.csv")
)
# Change plot title
avg_irf_emp_top_journals <- avg_irf_emp_top_journals$plot %>%
  plotly::layout(
    title = ""
  )
...
avg_irf_emp_other_publications <- plot_average_irfs(
  d_no_qc %>%
    filter(
      period.month %in% seq(0, 60, by = 3),
      outcome == out_var,
      top_5_or_tier == "other publication"
    ),
  period_limit = 60,
  winsor = TRUE,
  wins_par = wins_para,
...
# Save data as csv
write_csv(
  avg_irf_emp_other_publications$data,
  here::here(save_path, "avg_irf_emp_other_publications.csv")
)
# Change plot title
avg_irf_emp_other_publications <- avg_irf_emp_other_publications$plot %>%
  plotly::layout(
    title = ""
  )

#### Joint figure, top journals right plot, other left
figure_average_irfs_emp_top_journals_other_publications <- subplot(
  avg_irf_emp_other_publications,
  ...
  layout(
    xaxis = list(title = "Months"),
    xaxis2 = list(title = "Months"),
    yaxis = list(title = "Effect (%)", range = list(y_lims[1], y_lims[2])),
    hovermode = "compare"
  )
# Display figure
...
d_no_qc %>%
  ...
  labs(
    title = "Distribution of Journals by Period",
    x = "Period",
    y = "Count",
...
avg_irf_emp_cbanker <- plot_average_irfs(
  d_no_qc %>%
    filter(
      period.month %in% seq(0, 60, by = 3),
      outcome == out_var,
      cbanker == "central bank affiliated"
    ),
  period_limit = 60,
  winsor = TRUE,
  wins_par = wins_para,
...
# Save data as csv
write_csv(
  avg_irf_emp_cbanker$data,
  here::here(save_path, "avg_irf_emp_cbanker.csv")
)
# Change plot title
avg_irf_emp_cbanker <- avg_irf_emp_cbanker$plot %>%
  plotly::layout(
    title = ""
  )
...
avg_irf_emp_non_cbanker <- plot_average_irfs(
  d_no_qc %>%
    filter(
      period.month %in% seq(0, 60, by = 3),
      outcome == out_var,
      cbanker == "non-central bank affiliated"
    ),
  period_limit = 60,
  winsor = TRUE,
  wins_par = wins_para,
...
# Save data as csv
write_csv(
  avg_irf_emp_non_cbanker$data,
  here::here(save_path, "avg_irf_emp_non_cbanker.csv")
)
# Change plot title
avg_irf_emp_non_cbanker <- avg_irf_emp_non_cbanker$plot %>%
  plotly::layout(
    title = ""
  )
...
y_lims <- c(-2.5, 1)
figure_average_irfs_emp_cbanker_non_cbanker <- subplot(
  avg_irf_emp_non_cbanker,
  avg_irf_emp_cbanker,
  nrows = 1,
  shareY = TRUE
) %>%
  ...
  layout(
    annotations = list(
      list(
        x = 0.25,
        y = 1,
        text = "Non-central bank affiliated",
        showarrow = FALSE,
        xref = "paper",
        yref = "paper",
        xanchor = "center",
...
d_no_qc %>%
  ...
  geom_bar(position = "dodge") +
  labs(
    title = "Distribution of Central Bank Affiliation by Period",
    x = "Period",
    y = "Count",
...
# Change plot title
avg_irf_emp_chol <- avg_irf_emp_chol$plot %>%
  plotly::layout(
    title = "Cholesky"
  )
...
# Save data as csv
write_csv(
  avg_irf_emp_signr$data,
  here::here(save_path, "avg_irf_emp_signr.csv")
)
# Change plot title
avg_irf_emp_signr <- avg_irf_emp_signr$plot %>%
  plotly::layout(
...
# Change plot title
avg_irf_emp_hf <- avg_irf_emp_hf$plot %>%
  plotly::layout(
...
# Save data as csv
write_csv(
  avg_irf_emp_idother$data,
  here::here(save_path, "avg_irf_emp_idother.csv")
)
# Change plot title
avg_irf_emp_idother <- avg_irf_emp_idother$plot %>%
  plotly::layout(
...
# Change plot title
avg_irf_emp_nr <- avg_irf_emp_nr$plot %>%
  plotly::layout(
    title = "Narrative"
  )
...
y_lims <- c(-5, 2)
figure_average_irfs_emp_identification_methods <- subplot(
  avg_irf_emp_chol,
  avg_irf_emp_signr,
  avg_irf_emp_hf,
  avg_irf_emp_nr,
...
d_no_qc %>%
  ...
  geom_bar(position = "dodge") +
  labs(
    title = "Distribution of Identification Methods by Period",
    x = "Period",
    y = "Count",
...
# Save data as csv
write_csv(
  avg_irf_emp_chol_top_journals$data,
  here::here(save_path, "avg_irf_emp_chol_top_journals.csv")
)
# Change plot title
avg_irf_emp_chol_top_journals <- avg_irf_emp_chol_top_journals$plot %>%
  plotly::layout(
    title = "Cholesky"
  )
...
# Save data as csv
write_csv(
  avg_irf_emp_signr_top_journals$data,
  here::here(save_path, "avg_irf_emp_signr_top_journals.csv")
)
# Change plot title
avg_irf_emp_signr_top_journals <- avg_irf_emp_signr_top_journals$plot %>%
  plotly::layout(
    title = "Sign restrictions"
  )
...
# Save data as csv
write_csv(
  avg_irf_emp_hf_top_journals$data,
  here::here(save_path, "avg_irf_emp_hf_top_journals.csv")
)
# Change plot title
avg_irf_emp_hf_top_journals <- avg_irf_emp_hf_top_journals$plot %>%
  plotly::layout(
    title = "High frequency"
  )
...
# Save data as csv
write_csv(
  avg_irf_emp_idother_top_journals$data,
  here::here(save_path, "avg_irf_emp_idother_top_journals.csv")
)
# Change plot title
avg_irf_emp_idother_top_journals <- avg_irf_emp_idother_top_journals$plot %>%
  plotly::layout(
    title = "Other identification methods"
  )
...
# Save data as csv
write_csv(
  avg_irf_emp_nr_top_journals$data,
  here::here(save_path, "avg_irf_emp_nr_top_journals.csv")
)
# Change plot title
avg_irf_emp_nr_top_journals <- avg_irf_emp_nr_top_journals$plot %>%
  plotly::layout(
    title = "Narrative"
  )
...
# Joint figure, one row
y_lims <- c(-10, 3)
figure_average_irfs_emp_identification_methods_top_journals <- subplot(
  avg_irf_emp_chol_top_journals,
...
# Save data as csv
write_csv(
  avg_irf_emp_chol_other_publications$data,
  here::here(save_path, "avg_irf_emp_chol_other_publications.csv")
)
# Change plot title
avg_irf_emp_chol_other_publications <- avg_irf_emp_chol_other_publications$plot %>%
  plotly::layout(
    title = "Cholesky"
  )
...
# Save data as csv
write_csv(
  avg_irf_emp_signr_other_publications$data,
  here::here(save_path, "avg_irf_emp_signr_other_publications.csv")
)
# Change plot title
avg_irf_emp_signr_other_publications <- avg_irf_emp_signr_other_publications$plot %>%
  plotly::layout(
    title = "Sign restrictions"
  )
...
# Save data as csv
write_csv(
  avg_irf_emp_hf_other_publications$data,
  here::here(save_path, "avg_irf_emp_hf_other_publications.csv")
)
# Change plot title
avg_irf_emp_hf_other_publications <- avg_irf_emp_hf_other_publications$plot %>%
  plotly::layout(
    title = "High frequency"
  )
...
# Save data as csv
write_csv(
  avg_irf_emp_idother_other_publications$data,
  here::here(save_path, "avg_irf_emp_idother_other_publications.csv")
)
# Change plot title
avg_irf_emp_idother_other_publications <- avg_irf_emp_idother_other_publications$plot %>%
  plotly::layout(
    title = "Other identification methods"
  )
...
# Save data as csv
write_csv(
  avg_irf_emp_nr_other_publications$data,
  here::here(save_path, "avg_irf_emp_nr_other_publications.csv")
)
# Change plot title
avg_irf_emp_nr_other_publications <- avg_irf_emp_nr_other_publications$plot %>%
  plotly::layout(
    title = "Narrative"
  )
...
# Joint figure, one row
y_lims <- c(-10, 3)
figure_average_irfs_emp_identification_methods_other_publications <- subplot(
  avg_irf_emp_chol_other_publications,
...
y_lims <- c(-10, 3)
figure_average_irfs_emp_identification_methods_top_journals_other_publications <- subplot(
  figure_average_irfs_emp_identification_methods_other_publications,
  figure_average_irfs_emp_identification_methods_top_journals,
  nrows = 2,
  margin = 0.05
...
avg_irf_emp_us <- plot_average_irfs(
  d_no_qc %>%
    filter(period.month %in% seq(0, 60, by = 3), outcome == out_var, us == 1),
  period_limit = 60,
  winsor = TRUE,
  wins_par = wins_para,
  corrected_irf = NULL,
...
# Change plot title
avg_irf_emp_us <- avg_irf_emp_us$plot %>%
  plotly::layout(
    title = "US"
  )
...
avg_irf_emp_ea12 <- plot_average_irfs(
  d_no_qc %>%
    filter(period.month %in% seq(0, 60, by = 3), outcome == out_var, ea12 == 1),
  period_limit = 60,
  winsor = TRUE,
  wins_par = wins_para,
  corrected_irf = NULL,
...
# Change plot title
avg_irf_emp_ea12 <- avg_irf_emp_ea12$plot %>%
  plotly::layout(
    title = "EA12"
  )
...
# Save data as csv
write_csv(
  avg_irf_emp_upper_middle$data,
  here::here(save_path, "avg_irf_emp_upper_middle.csv")
)
# Change plot title
avg_irf_emp_upper_middle <- avg_irf_emp_upper_middle$plot %>%
  plotly::layout(
...
# Save data as csv
write_csv(
  avg_irf_emp_other_high_income$data,
  here::here(save_path, "avg_irf_emp_other_high_income.csv")
)
# Change plot title
avg_irf_emp_other_high_income <- avg_irf_emp_other_high_income$plot %>%
  plotly::layout(
...
#### Joint plot
y_lims <- c(-3, 1.5)
figure_average_irfs_emp_country_region <- subplot(
  avg_irf_emp_us,
  avg_irf_emp_ea12,
...
# Save data as csv
write_csv(
  avg_irf_unemp_top_journals$data,
  here::here(save_path, "avg_irf_unemp_top_journals.csv")
)
# Change plot title
avg_irf_unemp_top_journals <- avg_irf_unemp_top_journals$plot %>%
  plotly::layout(
    title = "Top journals"
  )
...
# Save data as csv
write_csv(
  avg_irf_unemp_other_publications$data,
  here::here(save_path, "avg_irf_unemp_other_publications.csv")
)
# Change plot title
avg_irf_unemp_other_publications <- avg_irf_unemp_other_publications$plot %>%
  plotly::layout(
...
#### Joint figure, top journals right plot, other left
y_lims <- c(-0.4, 1.25)
figure_average_irfs_unemp_top_journals_other_publications <- subplot(
  avg_irf_unemp_other_publications,
...
# Save data as csv
write_csv(
  avg_irf_unemp_cbanker$data,
  here::here(save_path, "avg_irf_unemp_cbanker.csv")
)
# Change plot title
avg_irf_unemp_cbanker <- avg_irf_unemp_cbanker$plot %>%
  plotly::layout(
...
# Save data as csv
write_csv(
  avg_irf_unemp_non_cbanker$data,
  here::here(save_path, "avg_irf_unemp_non_cbanker.csv")
)
# Change plot title
avg_irf_unemp_non_cbanker <- avg_irf_unemp_non_cbanker$plot %>%
  plotly::layout(
...
# Joint figure, cbanker right plot, non-cbanker left
y_lims <- c(-2, 0.5)
figure_average_irfs_unemp_cbanker_non_cbanker <- subplot(
  avg_irf_unemp_non_cbanker,
...
# Save data as csv
write_csv(
  avg_irf_unemp_chol$data,
  here::here(save_path, "avg_irf_unemp_chol.csv")
)
# Change plot title
avg_irf_unemp_chol <- avg_irf_unemp_chol$plot %>%
  plotly::layout(
    title = "Cholesky & SVAR"
  )
...
# Save data as csv
write_csv(
  avg_irf_unemp_signr$data,
  here::here(save_path, "avg_irf_unemp_signr.csv")
)
# Change plot title
avg_irf_unemp_signr <- avg_irf_unemp_signr$plot %>%
  plotly::layout(
    title = "Sign restrictions"
  )
...
# Change plot title
avg_irf_unemp_hf <- avg_irf_unemp_hf$plot %>%
  plotly::layout(
    title = "High frequency"
  )
...
# Save data as csv
write_csv(
  avg_irf_unemp_idother$data,
  here::here(save_path, "avg_irf_unemp_idother.csv")
)
# Change plot title
avg_irf_unemp_idother <- avg_irf_unemp_idother$plot %>%
  plotly::layout(
    title = "Other identification methods"
  )
...
# Change plot title
avg_irf_unemp_nr <- avg_irf_unemp_nr$plot %>%
  plotly::layout(
    title = "Narrative"
  )
...
# Joint figure, one row
y_lims <- c(-1, 1.5)
figure_average_irfs_unemp_identification_methods <- subplot(
  avg_irf_unemp_chol,
  avg_irf_unemp_signr,
  avg_irf_unemp_hf,
  avg_irf_unemp_nr,
...
# Save data as csv
write_csv(
  avg_irf_unemp_chol_top_journals$data,
  here::here(save_path, "avg_irf_unemp_chol_top_journals.csv")
)
# Change plot title
avg_irf_unemp_chol_top_journals <- avg_irf_unemp_chol_top_journals$plot %>%
  plotly::layout(
    title = "Cholesky"
  )
...
# Save data as csv
write_csv(
  avg_irf_unemp_signr_top_journals$data,
  here::here(save_path, "avg_irf_unemp_signr_top_journals.csv")
)
# Change plot title
avg_irf_unemp_signr_top_journals <- avg_irf_unemp_signr_top_journals$plot %>%
  plotly::layout(
    title = "Sign restrictions"
  )
...
# Save data as csv
write_csv(
  avg_irf_unemp_hf_top_journals$data,
  here::here(save_path, "avg_irf_unemp_hf_top_journals.csv")
)
# Change plot title
avg_irf_unemp_hf_top_journals <- avg_irf_unemp_hf_top_journals$plot %>%
  plotly::layout(
    title = "High frequency"
  )
...
# Save data as csv
write_csv(
  avg_irf_unemp_idother_top_journals$data,
  here::here(save_path, "avg_irf_unemp_idother_top_journals.csv")
)
# Change plot title
avg_irf_unemp_idother_top_journals <- avg_irf_unemp_idother_top_journals$plot %>%
  plotly::layout(
    title = "Other identification methods"
  )
...
# Save data as csv
write_csv(
  avg_irf_unemp_nr_top_journals$data,
  here::here(save_path, "avg_irf_unemp_nr_top_journals.csv")
)
# Change plot title
avg_irf_unemp_nr_top_journals <- avg_irf_unemp_nr_top_journals$plot %>%
  plotly::layout(
    title = "Narrative"
  )
...
# Joint figure, one row
y_lims <- c(-5, 0.75)
figure_average_irfs_unemp_identification_methods_top_journals <- subplot(
  avg_irf_unemp_chol_top_journals,
...
# Save data as csv
write_csv(
  avg_irf_unemp_chol_other_publications$data,
  here::here(save_path, "avg_irf_unemp_chol_other_publications.csv")
)
# Change plot title
avg_irf_unemp_chol_other_publications <- avg_irf_unemp_chol_other_publications$plot %>%
  plotly::layout(
    title = "Cholesky"
  )
...
# Save data as csv
write_csv(
  avg_irf_unemp_signr_other_publications$data,
  here::here(save_path, "avg_irf_unemp_signr_other_publications.csv")
)
# Change plot title
avg_irf_unemp_signr_other_publications <- avg_irf_unemp_signr_other_publications$plot %>%
  plotly::layout(
    title = "Sign restrictions"
  )
...
# Save data as csv
write_csv(
  avg_irf_unemp_hf_other_publications$data,
  here::here(save_path, "avg_irf_unemp_hf_other_publications.csv")
)
# Change plot title
avg_irf_unemp_hf_other_publications <- avg_irf_unemp_hf_other_publications$plot %>%
  plotly::layout(
    title = "High frequency"
  )
...
# Save data as csv
write_csv(
  avg_irf_unemp_idother_other_publications$data,
  here::here(save_path, "avg_irf_unemp_idother_other_publications.csv")
)
# Change plot title
avg_irf_unemp_idother_other_publications <- avg_irf_unemp_idother_other_publications$plot %>%
  plotly::layout(
    title = "Other identification methods"
  )
...
# Save data as csv
write_csv(
  avg_irf_unemp_nr_other_publications$data,
  here::here(save_path, "avg_irf_unemp_nr_other_publications.csv")
)
# Change plot title
avg_irf_unemp_nr_other_publications <- avg_irf_unemp_nr_other_publications$plot %>%
  plotly::layout(
    title = "Narrative"
  )
...
# Joint figure, one row
y_lims <- c(-3, 0.5)
figure_average_irfs_unemp_identification_methods_other_publications <- subplot(
  avg_irf_unemp_chol_other_publications,
...
# Joint figure top journals vs other publications by identification method, two rows, first other, then top
y_lims <- c(-8, 1)
figure_average_irfs_unemp_identification_methods_top_journals_other_publications <- subplot(
  figure_average_irfs_unemp_identification_methods_other_publications,
  figure_average_irfs_unemp_identification_methods_top_journals,
  nrows = 2,
  margin = 0.05
...
# Change plot title
avg_irf_unemp_us <- avg_irf_unemp_us$plot %>%
  plotly::layout(
    title = "US"
  )
...
# Save data as csv
write_csv(
  avg_irf_unemp_ea12$data,
  here::here(save_path, "avg_irf_unemp_ea12.csv")
)
# Change plot title
avg_irf_unemp_ea12 <- avg_irf_unemp_ea12$plot %>%
  plotly::layout(
    title = "EA12"
  )
...
# Save data as csv
write_csv(
  avg_irf_unemp_upper_middle$data,
  here::here(save_path, "avg_irf_unemp_upper_middle.csv")
)
# Change plot title
avg_irf_unemp_upper_middle <- avg_irf_unemp_upper_middle$plot %>%
  plotly::layout(
...
# Save data as csv
write_csv(
  avg_irf_unemp_other_high_income$data,
  here::here(save_path, "avg_irf_unemp_other_high_income.csv")
)
# Change plot title
avg_irf_unemp_other_high_income <- avg_irf_unemp_other_high_income$plot %>%
  plotly::layout(
...
#### Joint plot
y_lims <- c(-1, 1)
figure_average_irfs_unemp_country_region <- subplot(
  avg_irf_unemp_us,
  avg_irf_unemp_ea12,
