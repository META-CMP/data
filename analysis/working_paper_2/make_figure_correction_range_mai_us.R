...
write_csv(
  ...
  here::here(paste0(
    ...
    subfolder,
    "/figure_irf_range_correction_emp_us.csv"
  ))
)
...
orca(
  ...
  file = paste0(
    "analysis/working_paper_2/figures/irf_range_correction/",
    subfolder,
    "/figure_irf_range_correction_emp_us.pdf"
  ),
  scale = NULL,
  width = 1500 * 0.6,
  height = 1100 * 0.6
...
write_csv(
  ...
  here::here(paste0(
    "analysis/working_paper_2/figures/irf_range_correction/",
    subfolder,
    "/figure_irf_range_correction_unemp_us.csv"
  ))
)
...
orca(
  ...
  file = paste0(
    "analysis/working_paper_2/figures/irf_range_correction/",
    subfolder,
    "/figure_irf_range_correction_unemp_us.pdf"
  ),
  scale = NULL,
  width = 1500 * 0.6,
  height = 1100 * 0.6
...
write_csv(
  ...
  here::here(paste0(
    "analysis/working_paper_2/figures/irf_range_correction/",
    subfolder,
    "/figure_irf_range_correction_rate_us.csv"
  ))
)
...
orca(
  ...
  file = paste0(
    "analysis/working_paper_2/figures/irf_range_correction/",
    subfolder,
    "/figure_irf_range_correction_rate_us.pdf"
  ),
  scale = NULL,
  width = 1500 * 0.6,
  height = 1100 * 0.6
...
orca(
  ...
  file = paste0(
    "analysis/working_paper_2/figures/irf_range_correction/",
    subfolder,
    "/figure_irf_range_correction_all_us.pdf"
  ),
  scale = NULL,
  width = 1034,
  height = 486 * 1.2
