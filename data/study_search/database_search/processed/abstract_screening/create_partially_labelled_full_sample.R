...
d_full <- read_csv(here("data/study_search/database_search/processed/abstract_screening/unlabelled_full_sample.csv"))
...
d_lab <- read_csv(here("data/study_search/database_search/processed/abstract_screening/1_percent_random_sample/asreview_dataset_all_morpep-meta-cmp-1-percent-random-sample-fully-labelled.csv"))
...
write.csv(d_full_lab, here("data/study_search/database_search/processed/abstract_screening/partially_labelled_full_sample.csv"), row.names = FALSE)
