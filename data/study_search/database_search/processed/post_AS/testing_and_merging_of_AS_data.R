...
s1_data <- read_csv(here("data/study_search/database_search/processed/post_AS/screener_1_data/asreview_dataset_all_abstract-screening-morpep-meta-cmp-screener-1.csv"))

# Importing screener 2 data (all)
s2_data <- read_csv(here("data/study_search/database_search/processed/post_AS/screener_2_data/asreview_dataset_all_abstract-screening-morpep-meta-cmp-screener-2.csv"))
...
# save_to_xlsx(data_for_download, here("data/study_search/database_search/processed/post_AS/packages_for_full_text_download/study_set"))
