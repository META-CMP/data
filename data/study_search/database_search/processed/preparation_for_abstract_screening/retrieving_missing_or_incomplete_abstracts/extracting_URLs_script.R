...
filter_gs_entries(
  filepath = here::here("data/study_search/database_search/processed/preparation_for_abstract_screening/merging_of_EL_and_GS_results_and_duplicate_removal/merged_EL_GS_no_duplicates.csv"), 
  new_filepath = here::here("data/study_search/database_search/processed/preparation_for_abstract_screening/retrieving_missing_or_incomplete_abstracts/entries_without_complete_abstracts.csv")
  )

# Export the entries that have seemingly complete abstracts.
filter_complete_entries(
  filepath = here::here("data/study_search/database_search/processed/preparation_for_abstract_screening/merging_of_EL_and_GS_results_and_duplicate_removal/merged_EL_GS_no_duplicates.csv"), 
  new_filepath = here::here("data/study_search/database_search/processed/preparation_for_abstract_screening/retrieving_missing_or_incomplete_abstracts/entries_complete_abstracts.csv")
)

# Extract URLs of entries without complete abstract.
extract_urls(
  filepath = here::here("data/study_search/database_search/processed/preparation_for_abstract_screening/retrieving_missing_or_incomplete_abstracts/entries_without_complete_abstracts.csv"),
  col_name = "Url", 
  n = 100, 
  dir = here::here("data/study_search/database_search/processed/preparation_for_abstract_screening/retrieving_missing_or_incomplete_abstracts/URLs")
  )
...
extract_titles_of_NA_urls(
  ...
  col_name = "Title",
  n = 100, 
  dir = here::here("data/study_search/database_search/processed/preparation_for_abstract_screening/retrieving_missing_or_incomplete_abstracts/titles")
)
